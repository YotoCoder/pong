...
class app():
	...
	def __init__(self):
		...
		listaladrillos = []
		listaPremios = []
		miFuente = pygame.font.SysFont('Arial',17)	
		...
		class ladrillo:
			...
			def dibujar(self):
				self.ladrillo = pygame.draw.rect(ventana,(255,100,100),(self.x,self.y,30,10))
		...
		class premio:
			...
			def dibujar(self):
				self.premio = pygame.draw.rect(ventana,(0,255,255),(self.x,self.y,10,10))
		...
		def level5():
			map1x = [10,50,90,130,170,250,290,330,368]
			map1y = [20,40,60,80,100,120,140,160,180,200,220,240,260,280,300,320,340,360,]
		...
		while True:
			...
			miTexto = miFuente.render('Nivel: '+str(level-1),1,color)
			...
			if yPos > 400:
				...
				if vidas <= 0:
					while salir != True:
						...
						miTexto = fuente.render('- Para salir presione "S"',0,color)
						miTexto1 = fuente.render('- Para reiniciar presione "R"',0,(255,0,0))
